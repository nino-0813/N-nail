            ...
            <div>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-stone-500 font-light mb-1">お電話でのご予約・お問い合わせ</p>
                    <p className="text-lg font-serif text-stone-800 tracking-wider">084-XXX-XXXX</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-stone-500 font-light mb-1">メールでのお問い合わせ</p>
                    <p className="text-lg font-serif text-stone-800 tracking-wider">info@n-nail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-stone-500 font-light mb-1">Instagram</p>
                    <a href="#" className="text-lg font-serif text-stone-800 tracking-wider hover:text-pink-400 transition-colors">@n_nail_fukuyama</a>
                  </div>
                </div>
              </div>
            </div>
